                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                                ...
                                <!-- Search Form -->
                                <form action="{{ route('admin.patient') }}" method="GET" class="form-inline d-flex flex-wrap mb-2 mb-md-0">
                                    <input type="text" name="search" class="form-control form-control-sm mr-2 mb-2 mb-sm-0"
                                        placeholder="Search by Name" value="{{ old('search', $search ?? '') }}">
                                    <button type="submit" class="btn btn-sm btn-primary mb-2 mb-sm-0">
                                        <i class="fas fa-search"></i> Search
                                    </button>
                                    <a href="{{ route('admin.patient') }}" class="btn btn-sm btn-secondary ml-sm-2 mb-2 mb-sm-0">

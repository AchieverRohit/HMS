                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <form id="editPatientForm" action="{{ route('admin.appointment.store', $patient->Id) }}"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-2 ml-auto">
                                                ...
                                                <span id="PatientNo"
                                                    class="form-control-plaintext bg-light text-muted px-2 rounded">
                                                    {{ $patient->PatientNo }}
                                                </span>
                                            </div>
                                            ...
                                            <div class="col-md-4 ml-auto">
                                                ...
                                                <select class="custom-select" id="DoctorId" Name="DoctorId">
                                                    ...
                                                    @foreach ($doctors as $item)
                                                        <option value="{{ $item->Id }}">Dr. {{ $item->FirstName }}
                                            ...
                                            <div class="col-md-4 ml-auto">
                                                ...
                                                <select class="custom-select" id="ServiceId" Name="ServiceId">
                                                    @foreach ($service as $item)
                                                        <option value="{{ $item->Id }}">{{ $item->ServiceName }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4 ml-auto">
                                                ...
                                                <select class="custom-select" id="Status" Name="StatusId">
                                                    @foreach ($status as $item)
                                                        <option value="{{ $item->Id }}">{{ $item->StatusName }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>

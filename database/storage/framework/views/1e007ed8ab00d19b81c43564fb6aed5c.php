                            ...
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">
                                        Welcome
                                        <?php if(session('LoggedAdminInfo')): ?>
                                        <?php echo e($LoggedAdminInfo->name); ?>

                                        <!-- Add more user information as needed -->
                                        <?php else: ?>
                                        <p>Access denied. Please <a href="<?php echo e(route('admin.login')); ?>">login</a> to view
                                            this page.</p>
                                        <?php endif; ?>
                                    </h3>
...
<?php /**PATH D:\xampp\htdocs\Demo001\project_name\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>